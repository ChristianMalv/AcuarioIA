    ...
    <section className="bg-gradient-to-br from-gray-50 to-gray-100 py-16">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <div className="relative overflow-hidden rounded-2xl shadow-xl h-[34rem] sm:h-[32rem] md:h-80">
            {promotions.map((promo, index) => (
              ...
              >
                ...
                {/* Content */}
                <div className="relative z-10 p-6 sm:p-8 md:p-12 text-white h-full flex items-start md:items-center">
