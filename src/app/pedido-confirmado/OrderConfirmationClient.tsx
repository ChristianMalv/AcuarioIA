      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-2xl shadow-lg p-6">
                ...
                <div className={`${statusInfo.bgColor} rounded-lg p-4 flex items-center space-x-3`}>
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Entrega estimada: {getEstimatedDelivery()}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-2xl shadow-lg p-6">
                ...
                <p className="text-gray-600 text-sm">
                  Tu pedido será entregado en {order.location === 'cdmx' ? '1-2 días hábiles' : '24 horas'} en{' '}
                  {order.location === 'cdmx' ? 'CDMX' : 'Mérida'}.
                </p>
              </div>
            </div>
          ...
          <div className="mt-8 text-center space-y-4">
            <p className="text-gray-600">Recibirás un email de confirmación con los detalles de tu pedido.</p>
