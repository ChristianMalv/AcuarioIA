...
export default function NuevoProducto() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Agregar el stock como un campo separado para la API
      ...
      success('Producto creado', `"${formData.name}" ha sido creado exitosamente.`)
      router.push('/admin/productos')
    } catch (err) {
      console.error('Error al crear producto:', err)
      const errorMessage = err instanceof Error ? err.message : 'Error al crear el producto. Por favor intenta de nuevo.'
